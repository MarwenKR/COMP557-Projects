...
public class BodyBox extends GraphNode {
	...
	//dimensions
		...
		public BodyBox( String name, double cx, double cy, double cz, double sx, double sy, double sz, double rx, double ry, double rz, double r, double g, double b ) {
			super(name);
	...
	public void display( GLAutoDrawable drawable, BasicPipeline pipeline ) {
        ...
        gl.glUniform1f( pipeline.ShininessID, 32.0f );
