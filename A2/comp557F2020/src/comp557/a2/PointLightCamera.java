...
public class PointLightCamera extends Camera {	
    ...
    public void draw( GLAutoDrawable drawable, ShadowPipeline pipeline ) {
		...
		// draw on the near plan of the frustum
		pipeline.translate(drawable, 0, 0, -near.getFloatValue());
		pipeline.scale(drawable,near.getFloatValue()/P.m00,near.getFloatValue()/P.m11, 0);
