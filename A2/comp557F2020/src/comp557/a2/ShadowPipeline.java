...
public class ShadowPipeline {
    ...
    private int V_lightID;
    private int P_lightID;
	...
	public ShadowPipeline( GLAutoDrawable drawable ) {
        ...
        // TODO: Objective 7, add extra uniforms to the basic lighting program help compute fragment in the light camera canonical viewing volume
         V_lightID = gl.glGetUniformLocation( basicLighting.glslProgramID, "V_light" );
         P_lightID = gl.glGetUniformLocation( basicLighting.glslProgramID, "P_light" );
	...
	public void startCameraViewPass( GLAutoDrawable drawable ) {
		...
		currentGLSLProgram.glUniformMatrix(gl,V_lightID, light.V );
		currentGLSLProgram.glUniformMatrix(gl,P_lightID, light.P );
	}
